...
[PostGraphile](https://www.graphile.org/postgraphile/) in library mode. The entire stack is written in TypeScript, with autogenerated
...
* **Email handling:**
  ...
  - **Email transport** — we've configured Nodemailer to use mailhog in development and SendInBlue in deployed mode
