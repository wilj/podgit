...
export async function makeApp({
  ...
  // TODO FIXME figure out how to build Ionic app without inline styles, images, etc
  // Then re-enable helmet/CSP/Content-Security-Policy
  ...
  // allows client JS to report logs back to server
  await middleware.installClientLogger(app);
