...
--
-- Name: create_api_key_result; Type: TYPE; Schema: app_public; Owner: -
--

CREATE TYPE app_public.create_api_key_result AS (
	api_key text
);
...
--
-- Name: create_api_key(text); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.create_api_key(api_key_name text) RETURNS app_public.create_api_key_result
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
declare
...
COMMENT ON FUNCTION app_public.current_user_id() IS 'Handy method to get the current user ID.';
...
--
-- Name: delete_api_key(text); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.delete_api_key(api_key_name text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
begin
...
begin
  -- Delete the session
  delete from app_private.sessions where user_id = app_public.current_user_id();
...
--
-- Name: update_workspace(text, jsonb); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.update_workspace(workspace_id text, data jsonb) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
declare
...
--
-- Name: workspace_keepalive(text); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.workspace_keepalive(workspace_id text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'pg_catalog', 'public', 'pg_temp'
    AS $$
declare
...
--
-- Name: user_api_keys; Type: TABLE; Schema: app_private; Owner: -
--

CREATE TABLE app_private.user_api_keys (
    user_id uuid NOT NULL,
    name text NOT NULL,
    api_key_hash text,
    api_key_generated_ts timestamp with time zone
);
...
--
-- Name: api_keys; Type: VIEW; Schema: app_public; Owner: -
--

CREATE VIEW app_public.api_keys AS
 SELECT user_api_keys.name,
    user_api_keys.api_key_generated_ts
   FROM app_private.user_api_keys
  WHERE (user_api_keys.user_id = app_public.current_user_id())
  ORDER BY user_api_keys.api_key_generated_ts;


--
-- Name: debug; Type: VIEW; Schema: app_public; Owner: -
--

CREATE VIEW app_public.debug AS
 SELECT user_api_keys.name,
    user_api_keys.api_key_generated_ts,
    app_public.current_user_id() AS useridsess,
...
--
-- Name: notes; Type: TABLE; Schema: app_public; Owner: -
--
...
CREATE TABLE app_public.notes (
    ...
    short_text_content text GENERATED ALWAYS AS ("left"(TRIM(BOTH FROM regexp_replace(regexp_replace(text_content, '[\n\r]+'::text, ' '::text, 'g'::text), '\s+'::text, ' '::text, 'g'::text)), 100)) STORED,
...
--
-- Name: workspaces; Type: TABLE; Schema: app_public; Owner: -
--

CREATE TABLE app_public.workspaces (
    user_id uuid NOT NULL,
    gitpod_workspace_id text NOT NULL,
...
--
-- Name: TABLE workspaces; Type: COMMENT; Schema: app_public; Owner: -
--

COMMENT ON TABLE app_public.workspaces IS '@omit create,update,delete';
...
--
-- Name: user_api_keys user_api_keys_pkey; Type: CONSTRAINT; Schema: app_private; Owner: -
--

ALTER TABLE ONLY app_private.user_api_keys
    ADD CONSTRAINT user_api_keys_pkey PRIMARY KEY (user_id, name);
...
--
-- Name: notes notes_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.notes
...
--
-- Name: workspaces workspaces_pkey; Type: CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.workspaces
    ADD CONSTRAINT workspaces_pkey PRIMARY KEY (user_id, gitpod_workspace_id);
...
--
-- Name: notes_last_updated_ts_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX notes_last_updated_ts_idx ON app_public.notes USING btree (last_updated_ts);


--
-- Name: notes_user_id_idx; Type: INDEX; Schema: app_public; Owner: -
--

CREATE INDEX notes_user_id_idx ON app_public.notes USING btree (user_id);
...
--
-- Name: user_api_keys user_api_keys_user_id_fkey; Type: FK CONSTRAINT; Schema: app_private; Owner: -
--

ALTER TABLE ONLY app_private.user_api_keys
    ADD CONSTRAINT user_api_keys_user_id_fkey FOREIGN KEY (user_id) REFERENCES app_public.users(id) ON DELETE CASCADE;
...
--
-- Name: notes notes_user_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.notes
    ADD CONSTRAINT notes_user_id_fkey FOREIGN KEY (user_id) REFERENCES app_public.users(id) ON DELETE CASCADE;
...
--
-- Name: workspaces workspaces_user_id_fkey; Type: FK CONSTRAINT; Schema: app_public; Owner: -
--

ALTER TABLE ONLY app_public.workspaces
    ADD CONSTRAINT workspaces_user_id_fkey FOREIGN KEY (user_id) REFERENCES app_public.users(id) ON DELETE CASCADE;
...
--
-- Name: user_api_keys manage_as_admin; Type: POLICY; Schema: app_private; Owner: -
--

CREATE POLICY manage_as_admin ON app_private.user_api_keys USING ((EXISTS ( SELECT 1
   FROM app_public.users
  WHERE ((users.is_admin IS TRUE) AND (users.id = app_public.current_user_id())))));


--
-- Name: user_api_keys select_all; Type: POLICY; Schema: app_private; Owner: -
--

CREATE POLICY select_all ON app_private.user_api_keys FOR SELECT USING (true);
...
--
-- Name: user_api_keys; Type: ROW SECURITY; Schema: app_private; Owner: -
--
...
--
-- Name: notes delete_own; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: workspaces delete_own; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY delete_own ON app_public.workspaces FOR DELETE USING ((user_id = app_public.current_user_id()));


--
-- Name: notes insert_own; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: workspaces insert_own; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY insert_own ON app_public.workspaces FOR INSERT WITH CHECK ((user_id = app_public.current_user_id()));


--
-- Name: notes; Type: ROW SECURITY; Schema: app_public; Owner: -
--
...
--
-- Name: notes select_own; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: workspaces select_own; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY select_own ON app_public.workspaces FOR SELECT USING ((user_id = app_public.current_user_id()));


--
-- Name: notes update_own; Type: POLICY; Schema: app_public; Owner: -
--
...
--
-- Name: workspaces update_own; Type: POLICY; Schema: app_public; Owner: -
--

CREATE POLICY update_own ON app_public.workspaces FOR UPDATE USING ((user_id = app_public.current_user_id()));
...
--
-- Name: workspaces; Type: ROW SECURITY; Schema: app_public; Owner: -
--
...
GRANT USAGE ON SCHEMA app_hidden TO podgit_visitor;
...
GRANT USAGE ON SCHEMA app_public TO podgit_visitor;
...
GRANT ALL ON SCHEMA public TO podgit;
GRANT USAGE ON SCHEMA public TO podgit_visitor;
...
GRANT SELECT ON TABLE app_public.users TO podgit_visitor;
...
GRANT UPDATE(username) ON TABLE app_public.users TO podgit_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.users TO podgit_visitor;
...
GRANT UPDATE(avatar_url) ON TABLE app_public.users TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.accept_invitation_to_organization(invitation_id uuid, code text) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.change_password(old_password text, new_password text) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.confirm_account_deletion(token text) TO podgit_visitor;


--
-- Name: FUNCTION create_api_key(api_key_name text); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.create_api_key(api_key_name text) FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.create_api_key(api_key_name text) TO podgit_visitor;
...
GRANT SELECT ON TABLE app_public.organizations TO podgit_visitor;
...
GRANT UPDATE(slug) ON TABLE app_public.organizations TO podgit_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.organizations TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.create_organization(slug public.citext, name text) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public."current_user"() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_id() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_invited_organization_ids() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_member_organization_ids() TO podgit_visitor;


--
-- Name: FUNCTION delete_api_key(api_key_name text); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.delete_api_key(api_key_name text) FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.delete_api_key(api_key_name text) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.delete_organization(organization_id uuid) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.forgot_password(email public.citext) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.invite_to_organization(organization_id uuid, username public.citext, email public.citext) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.logout() TO podgit_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_emails TO podgit_visitor;
...
GRANT INSERT(email) ON TABLE app_public.user_emails TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.make_email_primary(email_id uuid) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.organization_for_invitation(invitation_id uuid, code text) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_billing_contact(org app_public.organizations) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.organizations_current_user_is_owner(org app_public.organizations) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.remove_from_organization(organization_id uuid, user_id uuid) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.request_account_deletion() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.resend_email_verification_code(email_id uuid) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.tg__graphql_subscription() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__forbid_if_verified() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__prevent_delete_last_email() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__verify_account_on_verified() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_users__deletion_organization_checks_and_actions() TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.transfer_organization_billing_contact(organization_id uuid, user_id uuid) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.transfer_organization_ownership(organization_id uuid, user_id uuid) TO podgit_visitor;


--
-- Name: FUNCTION update_workspace(workspace_id text, data jsonb); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.update_workspace(workspace_id text, data jsonb) FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.update_workspace(workspace_id text, data jsonb) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.users_has_password(u app_public.users) TO podgit_visitor;
...
GRANT ALL ON FUNCTION app_public.verify_email(user_email_id uuid, token text) TO podgit_visitor;


--
-- Name: FUNCTION workspace_keepalive(workspace_id text); Type: ACL; Schema: app_public; Owner: -
--

REVOKE ALL ON FUNCTION app_public.workspace_keepalive(workspace_id text) FROM PUBLIC;
GRANT ALL ON FUNCTION app_public.workspace_keepalive(workspace_id text) TO podgit_visitor;


--
-- Name: TABLE user_api_keys; Type: ACL; Schema: app_private; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE app_private.user_api_keys TO podgit_visitor;


--
-- Name: TABLE api_keys; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.api_keys TO podgit_visitor;


--
-- Name: TABLE debug; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT ON TABLE app_public.debug TO podgit_visitor;


--
-- Name: TABLE notes; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE app_public.notes TO podgit_visitor;
...
GRANT SELECT ON TABLE app_public.organization_memberships TO podgit_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_authentications TO podgit_visitor;


--
-- Name: TABLE workspaces; Type: ACL; Schema: app_public; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE app_public.workspaces TO podgit_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE podgit IN SCHEMA app_hidden GRANT SELECT,USAGE ON SEQUENCES  TO podgit_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE podgit IN SCHEMA app_hidden GRANT ALL ON FUNCTIONS  TO podgit_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE podgit IN SCHEMA app_public GRANT SELECT,USAGE ON SEQUENCES  TO podgit_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE podgit IN SCHEMA app_public GRANT ALL ON FUNCTIONS  TO podgit_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE podgit IN SCHEMA public GRANT SELECT,USAGE ON SEQUENCES  TO podgit_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE podgit IN SCHEMA public GRANT ALL ON FUNCTIONS  TO podgit_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE podgit REVOKE ALL ON FUNCTIONS  FROM PUBLIC;
